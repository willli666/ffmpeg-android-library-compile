...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --cross-prefix=/home/will/Downloads/android/ffmpeg-android/toolchain-android/bin/i686-linux-android- --arch=x86 --cpu=i686 --enable-runtime-cpudetect --sysroot=/home/will/Downloads/android/ffmpeg-android/toolchain-android/sysroot --enable-pic --enable-libx264 --enable-libfdk-aac --enable-pthreads --enable-version3 --enable-hardcoded-tables --enable-nonfree --enable-gpl --disable-encoders --enable-encoder=libx264 --enable-encoder=libx264rgb --enable-encoder=png --enable-encoder=bmp --enable-encoder=aac --disable-decoders --enable-decoder=h264 --enable-decoder=bmp --enable-decoder=png --enable-decoder=aac --disable-filters --enable-filter=scale --enable-filter=crop --enable-filter=amerge --enable-filter=pan --enable-filter=aresample --enable-filter=fps --disable-muxers --enable-muxer=image2 --enable-muxer=mov --enable-muxer=h264 --enable-muxer=mp4 --enable-muxer=h264 --disable-demuxers --enable-demuxer=image2 --enable-demuxer=mov --enable-demuxer=h264 --enable-demuxer=aac --disable-parsers --enable-parser=png --enable-parser=bmp --enable-parser=h264 --enable-parser=aac --disable-debug --disable-network --disable-ffplay --disable-ffprobe --disable-doc --disable-ffserver --disable-avdevice --disable-shared --enable-static --pkg-config=/home/will/Downloads/android/ffmpeg-android/ffmpeg-pkg-config --prefix=/home/will/Downloads/android/ffmpeg-android/build/x86 --extra-cflags='-I/home/will/Downloads/android/ffmpeg-android/toolchain-android/include -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -fno-strict-overflow -fstack-protector-all -march=i686' --extra-ldflags='-L/home/will/Downloads/android/ffmpeg-android/toolchain-android/lib -Wl,-z,relro -Wl,-z,now -pie' --extra-libs='-lpng -lm' --extra-cxxflags=
prefix=/home/will/Downloads/android/ffmpeg-android/build/x86
...
CXX=/home/will/Downloads/android/ffmpeg-android/toolchain-android/bin/i686-linux-android-g++
AS=/home/will/Downloads/android/ffmpeg-android/toolchain-android/bin/i686-linux-android-gcc
LD=/home/will/Downloads/android/ffmpeg-android/toolchain-android/bin/i686-linux-android-gcc
DEPCC=/home/will/Downloads/android/ffmpeg-android/toolchain-android/bin/i686-linux-android-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/home/will/Downloads/android/ffmpeg-android/toolchain-android/bin/i686-linux-android-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/home/will/Downloads/android/ffmpeg-android/toolchain-android/bin/i686-linux-android-ar
ARFLAGS=rc
AR_O=$@
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/home/will/Downloads/android/ffmpeg-android/toolchain-android/sysroot -isysroot /home/will/Downloads/android/ffmpeg-android/toolchain-android/sysroot -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -I/home/will/Downloads/android/ffmpeg-android/toolchain-android/include -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -fno-strict-overflow -fstack-protector-all -march=i686 -march=i686 -std=c99 -fomit-frame-pointer -fPIC -pthread -I/home/will/Downloads/android/ffmpeg-android/toolchain-android/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -I/home/will/Downloads/android/ffmpeg-android/toolchain-android/include -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -fno-strict-overflow -fstack-protector-all -march=i686 -march=i686 -fPIC
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=/home/will/Downloads/android/ffmpeg-android/toolchain-android/bin/i686-linux-android-windres
DEPWINDRES=/home/will/Downloads/android/ffmpeg-android/toolchain-android/bin/i686-linux-android-gcc
DOXYGEN=doxygen
LDFLAGS= -L/home/will/Downloads/android/ffmpeg-android/toolchain-android/lib -Wl,-z,relro -Wl,-z,now -pie  --sysroot=/home/will/Downloads/android/ffmpeg-android/toolchain-android/sysroot -isysroot /home/will/Downloads/android/ffmpeg-android/toolchain-android/sysroot -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
...
EXTRALIBS=-L/home/will/Downloads/android/ffmpeg-android/toolchain-android/lib -lx264 -lm -ldl -lfdk-aac -lm -lz -pthread -lpng -lm 
...
avdevice_FFLIBS=avfilter avformat swscale swresample avcodec avutil
avfilter_FFLIBS=swscale swresample avutil
